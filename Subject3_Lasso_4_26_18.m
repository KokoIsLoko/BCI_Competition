...
clear; clc;
load('predicted_dg_v3.mat')

% Get data
session = IEEGSession('I521_Sub3_Training_ecog', 'dweiss', 'Dwe_ieeglogin');
...
for i = 1:5
    ...
    predicted(:,i) = [zeros(250,1);pred(:,i);zeros(49,1)];
end

predicted_dg_v3{3} = predicted;
